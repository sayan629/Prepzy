    ...
    <div className="min-h-screen px-6 flex flex-col items-center">
        <div className = "w-full max-w-2xl">
            <div className="text-center mb-10">
                <SectionLabel> Welcome aboard! Your next favorite website starts here. </SectionLabel>
                <h1 className = "font-serif text-5xl leading-tight tracking-tighter mt-1">
                    <GrayTitle>Let's turn</GrayTitle>
                    <br/>
                    <GoldTitle>prep into offers.</GoldTitle>
                </h1>
                <p className = "text-sm text-stone-500 font-light mt-4 leading-relaxed">
                    Choose what fits your career goals.
                    <span className="text-stone-600">
                        {" "}
                        Prepzy will customize your experience from there.
                    </span>
                </p>
            </div>
            ...
            {!role && ( 
                ...
                {ONBOARDING_ROLES.map((r)=>(
                    <button
                     ...
                     hover:border-amber-400/20 hover:-translate-y-0.5
