...
// ── CHANGE THIS ───────────────────────────────────────────────────────────────
const BOOKING_ID = "f9b99487-7b4a-41a7-933b-b29e7cc5b3a3";
// ─────────────────────────────────────────────────────────────────────────────

const feedback = {
  summary:
    "Sayan demonstrated a solid understanding of React fundamentals and component architecture. He approached problems methodically and showed good instincts around state management. With some refinement in system design and async patterns, he's well on track for a mid-level frontend role.",
  technical:
  ...
  recommendation:
    "Recommended for mid-level frontend roles at growth-stage startups. Not yet ready for senior MAANG interviews without deepening system design knowledge. Suggest focusing on: async JavaScript internals, large-scale component architecture, and DP patterns.",
  strengths: [
  ...
  sessionRating: 4,
  sessionComment:
    "Great session — Sayan was engaged and receptive to feedback. Would be happy to interview him again after he's done more system design prep.",
};
